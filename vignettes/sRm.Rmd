...
`sRm` is designed to make use of existing packages (ie, much of the heavy lifting is done by `mzR` and `xcms`) and create a simple S4 interface to the user for processing and visualisation. 
